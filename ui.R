...
absolutePanel(id = "datatable", class = "panel panel-default", fixed = TRUE,
              ...
              tabPanel("Themes",
                       fixedRow(column(6,textInput("themeName", "Theme's name")),
                                column(6,br(),
                                       actionLink("previous", label = "Previous"),
                                       HTML(" | "),
                                       actionLink("next", label = "Next"),
                                       br(),
                                       actionLink("copy", label = "Copy ( to new)"),
                                       HTML(" | "),
                                       actionLink("new", label = "New"))),
                       h5(tags$strong("Tags")),
              ...
              tabPanel("Captions",
                       h4("To be made"),
                       aceEditor("caption", value="test", mode="html", theme="ambient", readOnly = FALSE,
